...
class Post(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='hobby_posts')
    
    likes = models.ManyToManyField(User, related_name='liked_hobby_posts', blank=True) # 좋아요한 사용자들
...
class Comment(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='hobby_comments')  # 댓글 작성자
